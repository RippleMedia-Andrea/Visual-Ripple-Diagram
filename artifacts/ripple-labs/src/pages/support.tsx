...
export default function SupportPage() {
  return (
    <PublicPageLayout eyebrow="Purpose Lab" title="Need help?">
      ...
      <Section title="How do I reset my password?"><p>Choose “Forgot password?” on the Sign In page and follow the link in the email. If you don’t receive it, check your spam folder or contact support.</p></Section>
